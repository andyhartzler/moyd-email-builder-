...
/* ===== DESKTOP ONLY: Hide listmonk logo in navbar ===== */
/* On desktop, Bulma already hides hamburger, so hiding all navbar-brand children only hides the logo */
...
/* ===== MOBILE ONLY: Hamburger styling ===== */
/* On mobile, hamburger is visible by default, we just style it */
...
EOSQL
  ...
  function showHelp(){
    ...
    c.style.cssText="background:white;border-radius:16px;padding:24px;max-width:300px;width:100%;text-align:center;";
    ...
    s.style.cssText="flex:1;padding:12px 8px;background:#273351;color:white;text-decoration:none;border-radius:10px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:4px;";
    s.innerHTML="<span style=\"font-size:28px;line-height:1;\">&#x1F4AC;</span><span style=\"font-weight:bold;font-size:13px;\">Text</span>";
    var em=document.createElement("a");em.href="mailto:andrew@moyoungdemocrats.org?subject=Help&body="+encodeURIComponent(m);
    em.style.cssText="flex:1;padding:12px 8px;background:#273351;color:white;text-decoration:none;border-radius:10px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:4px;";
    em.innerHTML="<span style=\"font-size:28px;line-height:1;\">&#x1F4E7;</span><span style=\"font-weight:bold;font-size:13px;\">Email</span>";
